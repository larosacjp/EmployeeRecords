        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('employee-records')" :active="request()->routeIs('employee-records')" wire:navigate>
                        {{ __('Employee Records') }}
                    </x-nav-link>
                    <x-nav-link :href="route('employee-statistics')" :active="request()->routeIs('employee-statistics')" wire:navigate>
